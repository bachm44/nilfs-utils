...
void nilfs_suinfo_print(const struct nilfs_suinfo* si) 
{
	printf("nilfs_suinfo {\n");
	printf("	nblocks = %d\n", si->sui_nblocks);
	printf("	lastmod = %lld\n", si->sui_lastmod);
...
void nilfs_segment_print(const struct nilfs_segment* segment)
{
...
void nilfs_layout_print(const struct nilfs_layout* layout)
{
	printf("nilfs_layout {\n");
	printf("	rev_level = %d\n", layout->rev_level);
...
void nilfs_sustat_print(const struct nilfs_sustat* sustat)
{
	printf("nilfs_sustat {\n");
	printf("	ss_nsegs = %lld\n", sustat->ss_nsegs);
...
void print_block_content(int blocknr)
{
